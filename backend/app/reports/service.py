...
async def _build_narrative(assessments: list, all_dims: list) -> str:
    ...
    try:
        ...
        return (
            "## 发展建议（暂不可用，使用通用兜底）\n\n"
            "1. **家庭端**：请家长以非评判性的倾听与陪伴为先，避免指责或简单劝慰"
            "；保持大致固定的作息与用餐节奏，必要时与学校心理老师同步沟通。\n\n"
            "2. **学校端**：请班主任和心理老师关注受测者课堂参与度、社交状态与"
            "近期作业表现；若总分中重度及以上或出现危机信号，必须尽快联系专业机构评估。\n\n"
            "3. **自我调节**：可尝试每天 5 分钟腹式呼吸练习；若出现自伤或结束生命的念头，"
            "请立即拨打 12355 青少年心理援助热线，紧急危及生命请拨 120/110。"
        )
